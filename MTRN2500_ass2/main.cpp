		...
		if (!RemoteDataManager::IsConnected()) {
			if (frameCounter % 120 == 0) {
				...
				if (RemoteDataManager::IsConnected()) {
					...
					//dynamic cast vehicle into a pointer of MyVehicle and get localmd to pass in vm
					VehicleModel vm = ((MyVehicle*)vehicle)->getLocalmd();
					...
					RemoteDataManager::Write(GetVehicleModelStr(vm));//upload vm
				}
			}
		}
